...
try:
    import dspy
    from dspy import ChainOfThought, Module, OpenAI, Predict
    try:
...
class DSPyOrchestrator:
    ...
    def get_available_models(self) -> Dict[str, Any]:
        ...
        try:
            return {
                "reasoning_models": getattr(self.config.openai, 'get_reasoning_models', list)(),
                ...
                "cost_optimized": getattr(self.config.openai, 'get_cost_optimized_models', list)(),
                "dspy_available": DSPY_AVAILABLE
            }
        except Exception as e:
